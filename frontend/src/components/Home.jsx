          ...
          <section className="section flex flex-col lg:flex-row justify-center w-full min-h-screen ">
            <div className="reels w-full lg:w-[100%] max-w-[630px] min-h-screen">
              <div className="my-6">
                ...
                <section className="mt-14 mx-auto w-[90vw] sm:w-[80vw] md:w-[60vw] lg:w-[468px]">
                  {allPosts.map((post) => (
                    <article key={post._id} className="mb-6 border-b border-zinc-800">
                      <header className="flex items-center gap-2">
                        ...
                        <h2 className="text-sm font-bold">{post.author.username}</h2>
                      </header>

                      <figure className="mt-2 w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[585px] border-[.1px] border-zinc-800 flex justify-center items-center rounded-md overflow-hidden">
