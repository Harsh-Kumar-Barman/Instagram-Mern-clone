...
router.post('/send/message/:id',authMiddleware, sendMessage);  // Send message to individual user
...
router.post('/group/send/message/:groupId', sendGroupMessage);  // Send a message in a group chat
